...
# ----------------------------------------------Utility Functions----------------------------------------------------- #
# ----------------------------------------------Sort Model Filepaths Functions-------------------------------------- #
...
def record_iou_data(field, epoch, iou):
    ...
    df.loc[epoch] = [epoch] + [iou['02691156']] + [iou['02828884']] + [iou['02933112']] + [iou['02958343']] + [
        iou['03001627']
        ] + [iou['03211117']] + [iou['03636649']] + [iou['03691459']] + [iou['04090263']] + [iou['04256520']] + [
                        iou['04379243']
